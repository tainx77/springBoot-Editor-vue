package com.zlfinfo.common.ueditor;

import com.zlfinfo.common.ueditor.define.ActionMap;
...
//		System.out.println("-------enter ConfigManager222");
	...
	public static ConfigManager getInstance ( String rootPath, String contextPath, String uri ) {
		...
		try {
//			System.out.println("---------enter ConfigManager");
	...
	public JSONObject getAllConfig () {
		System.out.println(this.jsonConfig.toMap());
...
//		System.out.println("------enter initEnv");
...
//		System.out.println(input.replaceAll( "/\\*[\\s\\S]*?\\*/", "" )+"------------------");
